...
def step_gradient(old_theta,vektor_x,vektor_y,learningRate):
	m = len(vektor_y)
	# Вектор тэта
	theta = old_theta
	...
	new_theta = old_theta - (learningRate * delta)
	return new_theta
...
def gradient_runner(initial_theta,num_iterations,vektor_x,vektor_y,
													learningRate):
	theta = initial_theta
